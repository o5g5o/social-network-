...
func (app *App) HandleRegister(w http.ResponseWriter, r *http.Request) {
	...
	sendJSONResponse(w, http.StatusOK, map[string]string{"message": "Registration successful"})
}
...
func (app *App) HandleLogin(w http.ResponseWriter, r *http.Request) {
	...
	err = app.DB.QueryRow("SELECT image FROM users WHERE id = ?", id).Scan(&profilePic)
	if err != nil {
	...
	// Create session
	sessionID, err := app.CreateSession(id)
	if err != nil {
